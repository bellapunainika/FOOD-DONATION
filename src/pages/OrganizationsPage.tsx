          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {filteredDonations.map((donation) => (
              ...
              >
                ...
                <button className="w-full mt-4 bg-gradient-to-r from-brand-600 to-pink-600 hover:from-brand-700 hover:to-pink-700 text-white font-semibold py-2 rounded-lg transition-all group-hover:shadow-lg">
                  View Impact
                </button>
              </div>
            ))}
